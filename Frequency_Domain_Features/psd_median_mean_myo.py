...
psd_folder = r"C:\Users\USER\Desktop\A_final_data\PSD_Results\Myo"  # Folder with PSD CSV files
...
summary_path = os.path.join(summary_folder, "MNF_MDF_Summary_Myo.csv")
